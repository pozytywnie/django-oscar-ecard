...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'eCardPaymentRequest'
        db.delete_table('oscar_ecard_ecardpaymentrequest')

        # Deleting model 'eCardPaymentResponse'
        db.delete_table('oscar_ecard_ecardpaymentresponse')
    ...
    models = {
        ...
        'oscar_ecard.ecardpaymentrequest': {
            'Meta': {'object_name': 'eCardPaymentRequest', '_ormbases': ['payment.Source']},
            'source_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['payment.Source']", 'unique': 'True', 'primary_key': 'True'})
        },
        'oscar_ecard.ecardpaymentresponse': {
            'Meta': {'object_name': 'eCardPaymentResponse', '_ormbases': ['payment.Transaction']},
            'body': ('django.db.models.fields.TextField', [], {}),
            'ip': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'transaction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['payment.Transaction']", 'unique': 'True', 'primary_key': 'True'})
        },
        'payment.source': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'PLN'", 'max_length': '12'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
